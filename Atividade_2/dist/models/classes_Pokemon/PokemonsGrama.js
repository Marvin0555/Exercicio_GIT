...
exports.PokemonsGrama = exports.TipoGrama = void 0;
...
function PokemonsGrama(nome, vida, energia, velocidade) {
    const Pokemon_modelo_grama = new Pokemons_1.TodosPokemons(nome, "Grama", vida, energia, velocidade);
    const Pokemon_Grama = Pokemon_modelo_grama.clone();
    return Pokemon_Grama;
}
exports.PokemonsGrama = PokemonsGrama;
